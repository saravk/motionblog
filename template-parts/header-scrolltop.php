...
<style amp-custom>
  .scrollToTop {color: var(--color-text-light);box-shadow: var(--box-shadow-1);font-size: 1.4em;width: 60px;height: 60px;border-radius: 50%;border: none;outline: none;background: var(--color-primary);z-index: 9999;bottom: var(--space-2);right: var(--space-2);position: fixed;opacity: 0;visibility: hidden;}
